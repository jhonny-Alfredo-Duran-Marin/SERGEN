                        ...
                        <div class="form-group">
                            ...
                            <select name="categoria_id" class="form-control">
                                ...
                                @foreach($categorias as $c)
                                    <option value="{{ $c->id }}"
                                            @selected((string)request('categoria_id') === (string)$c->id)>
                                        {{ $c->descripcion }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        @foreach($items as $it)
                            ...
                            <tr data-search="{{ $search }}">
                                ...
                                <td>
                                    ...
                                    @if($it->ubicacion)
                                        <div class="small text-muted">
                                            <i class="fas fa-map-marker-alt"></i> {{ $it->ubicacion }}
                                        </div>
                                    @endif
                                </td>
                                ...
                                <td class="text-right">
                                    <span class="badge badge-{{ $it->cantidad <= $low ? 'danger' : 'success' }}"
                                        ...
                                        <i class="fas fa-{{ $it->cantidad <= $low ? 'exclamation-triangle' : 'check' }}"></i>
                                        {{ $it->cantidad }}
                                    </span>
                                </td>
                                ...
                                <td class="text-center">
                                    <span class="badge badge-{{ $it->estado === 'Activo' ? 'success' : 'secondary' }}">
                                        <i class="fas fa-{{ $it->estado === 'Activo' ? 'check-circle' : 'times-circle' }}"></i>
                                        {{ $it->estado }}
                                    </span>
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a class="btn btn-sm btn-info"
                                           href="{{ route('items.show', $it) }}"
                                           data-toggle="tooltip"
                                           title="Ver detalles">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a class="btn btn-sm btn-warning"
                                           href="{{ route('items.edit', $it) }}"
                                           data-toggle="tooltip"
                                           title="Editar item">
        ...
        <div class="col-md-12">
            <div class="info-box bg-gradient-info">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">Administra items, controla stock, categorías y costos del inventario</span>
                </div>
            </div>
        </div>
    </div>
